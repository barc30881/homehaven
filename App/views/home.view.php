            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <article class="card hover-effect-scale bg-primary-subtle border-0 overflow-hidden text-center">
                        <div class="card-body pt-sm-5 pb-3">
                            ...
                            <svg class="text-dark-emphasis my-3 mt-sm-0" xmlns="http://www.w3.org/2000/svg" width="48"
                        ...
                        <div
                            class="card-footer d-flex flex-column align-items-center gap-4 gap-sm-5 bg-transparent border-0 p-0">
                            <a class="btn btn-dark stretched-link mx-4" href="<?= url('listings')?>">Find a home</a>
                            <div class="ratio hover-effect-target mt-3 mt-sm-0"
                                style="--fn-aspect-ratio: calc(216 / 416 * 100%)">
                                <img src="<?= url('assets/img/home/real-estate/categories/01.png')?>" alt="Image">
                            </div>
                        </div>
                    </article>
                </div>
                ...
                <div class="swiper-slide">
                    <article class="card hover-effect-scale bg-info border-0 overflow-hidden text-center">
                        ...
                        <div
                            class="card-footer d-flex flex-column align-items-center gap-4 gap-sm-5 bg-transparent border-0 p-0">
                            <a class="btn btn-dark stretched-link mx-4" href="<?= url('auth/login')?>">Sell</a>
                            <div class="ratio hover-effect-target mt-3 mt-sm-0"
                                style="--fn-aspect-ratio: calc(216 / 416 * 100%)">
                                <img src="<?= url('assets/img/home/real-estate/categories/02.png')?>" alt="Image">
                            </div>
                        </div>
                    </article>
                </div>
                ...
                <div class="swiper-slide">
                    <article class="card hover-effect-scale bg-warning-subtle border-0 overflow-hidden text-center">
                        ...
                        <div
                            class="card-footer d-flex flex-column align-items-center gap-4 gap-sm-5 bg-transparent border-0 p-0">
                            <a class="btn btn-dark stretched-link mx-4" href="<?= url('listings')?>">Find a
                                Property</a>
                            <div class="ratio hover-effect-target mt-3 mt-sm-0"
                                style="--fn-aspect-ratio: calc(216 / 416 * 100%)">
                                <img src="<?= url('assets/img/home/real-estate/categories/03.png')?>" alt="Image">
                            </div>
                        </div>
                    </article>
                </div>
