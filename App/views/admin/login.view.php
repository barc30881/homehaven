    ...
    <main class="content-wrapper w-100 px-3 ps-lg-5 pe-lg-4 mx-auto" style="max-width: 1920px">
      <div class="d-lg-flex">
        ...
        <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
          ...
          <h1 class="h2 mt-auto">Welcome back Admin</h1>
          <!-- Form -->
          <form class="needs-validation" novalidate="" method="POST" action="<?= url('admin/auth/login') ?>">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="nav">
                <a class="nav-link animate-underline p-0" href="<?= url('auth/forget-password') ?>">
          ...
          <footer class="mt-auto">
            ...
            <p class="fs-xs mb-0">
              © All rights reserved. Connect Builders
            </p>
          </footer>
        </div>
        ...
        <div class="d-none d-lg-block w-100 py-4 ms-auto" style="max-width: 1034px">
          <div class="d-flex flex-column justify-content-end h-100 bg-info-subtle rounded-5">
            <div class="ratio" style="--fn-aspect-ratio: calc(1030 / 1032 * 100%)">
              <img src="<?= url('assets/img/account/account-cover.png') ?>" alt="cover">
            </div>
          </div>
        </div>
      </div>
