        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="personal-info" role="tabpanel" aria-labelledby="personal-info-tab">
            <div class="vstack gap-4">
              ...
              <!-- Settings form -->
              <form class="needs-validation" novalidate="" method="POST" action="<?= url('admin/account-settings') ?>" enctype="multipart/form-data">
              ...
              <div class="d-flex align-items-start align-items-sm-center mb-2">
                <div class="ratio ratio-1x1 hover-effect-opacity bg-body-tertiary border rounded-circle overflow-hidden"
                  ...
                  <img id="profile-preview" src=<?= htmlspecialchars(Session::get('admin')['profile_picture'] ?? '') ?? 'Micheal' ?> alt="Avatar">
                  <div
                   ...
                   <?php if(empty(Session::get('admin')['profile_picture'])) : ?>
                ...
                <div class="ps-3 ps-sm-4">
                  <p class="fs-sm" style="max-width: 440px">Your profile photo will appear on your profile and directory
                    ...
                    <input type="file" class="d-none btn btn-sm btn-outline-secondary" id="profile-input" name="profilepicture" accept="image/png, image/jpeg" onchange="previewProfile(event)"  > 
                ...
                <div class="row row-cols-1 row-cols-sm-2 g-4 mb-4">
                  <div class="col position-relative">
                    ...
                    <input type="text" class="form-control form-control-lg" id="fn" value="<?= htmlspecialchars(Session::get('admin')['firstname'] ?? '') ?? 'Micheal' ?>" required="" name="firstname"   >
                  ...
                  <div class="col position-relative">
                    ...
                    <input type="text" class="form-control form-control-lg" id="ln" value="<?= htmlspecialchars( Session::get('admin')['lastname'] ?? '') ?? 'Williams' ?>" required="" name="lastname" >
                  ...
                  <div class="col position-relative">
                    ...
                    <input type="email" class="form-control form-control-lg" id="email" value="<?= htmlspecialchars( Session::get('admin')['email'] ?? 'example@gmail.com') ?? 'example@gmail.com' ?>"
                      required="" >
                  ...
                  <div class="col position-relative">
                    ...
                    value="<?= htmlspecialchars( Session::get('admin')['phonenumber'] ?? '08120127329') ?? '09025557890' ?>" placeholder="(___) ___-____" required="" name="phonenumber"  >
                  ...
                  <div class="col">
                    ...
                    <div class="position-relative">
                      <input type="date" class="form-control form-control-lg form-icon-end" id="birth-date"
                        data-datepicker="{&quot;dateFormat&quot;: &quot;F j, Y&quot;}" placeholder="Choose date" name="dob" value="<?= htmlspecialchars( Session::get('admin')['dob'] ?? 'yyyy/mm/dd') ?? 'yyyy/mm/dd' ?>"   >
                    </div>
                  </div>
                </div>
                <div class="position-relative mb-4">
                  <label for="address" class="form-label fs-base">Address *</label>
                  <input type="text" class="form-control form-control-lg" id="address"  value="<?= htmlspecialchars( Session::get('admin')['address'] ?? 'New York, Brooklyn') ?? 'New York, Brooklyn' ?>"
                ...
                <div class="pb-2 mb-4">
                  ...
                  <textarea class="form-control form-control-lg bg-transparent" id="user-info"
                    rows="6" name="Information" >  <?= htmlspecialchars( Session::get('admin')['information'] ?? 'add your bio') ?? 'add your bio' ?>   </textarea>
                </div>
