...
<!-- Form -->
<form class="needs-validation" novalidate="" method="POST" action="<?= url('user/add-property-type')?>">
                ...
                <div class="col-lg-9 col-xl-8">
                    ...
                    <div class="pt-3 mt-3">
                        ...
                        <div class="nav nav-pills flex-wrap gap-3">
                            <div>
                                <input name="category" value="Sell property" type="radio" class="btn-check" id="sell"
                                    name="category" checked="">
                                <label class="nav-link" for="sell">Sell property</label>
                            </div>
                            <div>
                                <input name="category" value="Rent property" type="radio" class="btn-check" id="rent"
                                    name="category">
                    ...
                    <div class="pt-3 mt-3">
                        ...
                        <div class="nav nav-pills row row-cols-2 row-cols-sm-3 row-cols-md-5 gap-0 g-3">
                            <div class="col">
                                <input name="propertyType" value="Apartment" type="radio" class="btn-check"
                                    id="apartment" name="type" checked="">
                                <label class="nav-link flex-column w-100 align-items-center gap-2 rounded p-3"
                                    for="apartment">
                            ...
                            <div class="col">
                                <input name="propertyType" value="House" type="radio" class="btn-check" id="house"
                                    name="type">
                                <label class="nav-link flex-column w-100 align-items-center gap-2 rounded p-3"
                                    for="house">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor">
                            ...
                            <div class="col">
                                <input name="propertyType" value="Commercial" type="radio" class="btn-check"
                                    id="commercial" name="type">
                                <label class="nav-link flex-column w-100 align-items-center gap-2 rounded p-3"
                                    for="commercial">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor">
                                        <path fill-rule="evenodd"
                            ...
                            <div class="col">
                                <input name="propertyType" value="Room" type="radio" class="btn-check" id="room"
                                    name="type">
                                <label class="nav-link flex-column w-100 align-items-center gap-2 rounded p-3"
                                    for="room">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor">
                            ...
                            <div class="col">
                                <input name="propertyType" value="Garage" type="radio" class="btn-check" id="garage"
                                    name="type">
                                <label class="nav-link flex-column w-100 align-items-center gap-2 rounded p-3"
                                    for="garage">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor">
                    ...
                    <div class="pt-3 mt-3 mb-n2">
                        ...
                        <div class="vstack gap-2">
                            <div class="form-check mb-1">
                                <input name="Condition" value="Secondary market" type="radio" class="form-check-input"
                                    id="secondary" name="condition" checked="">
                                <label for="secondary" class="form-check-label">Secondary market</label>
                            </div>
                            <div class="form-check mb-1">
                                <input name="Condition" value="New building" type="radio" class="form-check-input"
                                    id="new" name="condition">
